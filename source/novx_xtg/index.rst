|external-link| `German <https://peter88213.github.io/mdnovhelp-de/novx_xtg>`__
...
The novx_xtg Python script runs through all chapters and sections of a mdnovel
...
The included installation script prompts you to create a shortcut on the desktop.
 You can launch the program by dragging a mdnovel project file and dropping it
...
- launch the program on the command line passing the mdnovel project file
  as an argument, or
...
The path of the mdnovel project file.
...
this is best done in advance with a word processor, e.g. via mdnovel's
"proof read" function.
...
- Place a subfolder named **novx_xtg** in the mdnovel project folder.
...
.. hint::
   ...
   *novx_xtg* default values in the *mdnovel* installation
   directory under
...
- **italic** - The opening tag to replace mdnovel's *italic* formatting.
- **italic0** - The closing tag to replace mdnovel's *italic* formatting.
- **bold** - The opening tag to replace mdnovel's *bold* formatting.
- **bold0** - The closing tag to replace mdnovel's *bold* formatting.
