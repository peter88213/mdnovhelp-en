|external-link| `German <https://peter88213.github.io/mdnovhelp-de/nv_aeon2/>`_
...
After installation, you can copy a "mdnovel.xml" template to the
...
properties that are converted to *mdnovel* by default.

You find the customized template in the *mdnovel* installation directory under
...
*Aeon Timeline 2* and *mdnovel* file dates are compared.


Tools > Aeon Timeline 2 > Update the timeline
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

If a timeline exists, update it from *mdnovel*.
...
After installation, you can copy a "mdnovel" template to the
*Aeon Timeline 2* custom template folder. The easiest way is to create new
timelines based on this template. It provides the entities and event
properties that are converted to *mdnovel* by default.
...
-  "Narrative" events that begin before 0001-01-01 in the timeline, will
   not be synchronized with *mdnovel*, because *mdnovel* can not handle
   these dates.
...
Conversion rules for newly created mdnovel projects
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The names/column labels refer to timelines based on the "mdnovel"
template.
...
Update rules for existing mdnovel projects
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
-  If a *mdnovel* section title occurs more than once, the converter
...
-  When processing unspecific "day/hour/minute" information, the default
   date from the *mdnovel* project is used. f there is no default date
   set, "today" is used.
...
-  When creating events from sections without any date/time information,
   they get the default date from the *mdnovel* project, and are sorted
   in reading order. If there is no default date set, "today" is used.
-  When processing unspecific "day/hour/minute" information, the default
   date from the *mdnovel* project is used for date calculation.
...
*mdnovel* and *Aeon Timeline 2* project files. It is only applied to this
...
*nv_aeon2* default values in the *mdnovel* installation
directory under
