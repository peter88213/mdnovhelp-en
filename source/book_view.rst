...
It is the initial view after opening a *mdnovel* project.
...
Log writing progress
   By default, *mdnovel* stores a log entry with the word counts
...
provide a PNG image file with the project name along with the *.mdnov*
