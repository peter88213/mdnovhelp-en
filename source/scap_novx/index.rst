|external-link| `German <https://peter88213.github.io/mdnovhelp-de/scap_novx/>`__
...
The scap_novx Python script creates a *mdnovel* project
...
*scap_novx* generates a new *mdnovel* project file with
...
.. note::
   If the *mdnovel* project already exists, it would
   not be overwritten.
   Character/Location/Item XML files are generated instead.
   They can be imported into any *mdnovel* project.
...
You find this a sample project in the *mdnovel* installation
directory under
...
your *mdnovel* and Timeline project files.
...
*scap_novx* default values in the *mdnovel* installation
directory under
